...
export const useSendOTP = () => {
  return useMutation({
    mutationFn: (data: SendOTPRequest): Promise<AuthResponse> =>
...
export const useForgotPassword = () => {
  return useMutation({
    mutationFn: (data: ForgotPasswordRequest): Promise<AuthResponse> =>
...
export const useResetPassword = () => {
  return useMutation({
    mutationFn: ({
      token,
      ...data
    }: ResetPasswordRequest & { token: string }): Promise<AuthResponse> =>
...
export const useChangePassword = () => {
  return useMutation({
    mutationFn: (data: ChangePasswordRequest): Promise<AuthResponse> =>
...
export const useResendVerification = () => {
  return useMutation({
    mutationFn: (data: { email: string }): Promise<AuthResponse> =>
